...
url_prefix_string = '/olvk4/pa4'
# number of seconds to timeout
session_timeout = 300

app.register_blueprint(controllers.album, url_prefix = url_prefix_string)
app.register_blueprint(controllers.album_edit, url_prefix = url_prefix_string)
app.register_blueprint(controllers.albums, url_prefix = url_prefix_string)
app.register_blueprint(controllers.albums_edit, url_prefix = url_prefix_string)
app.register_blueprint(controllers.pic, url_prefix = url_prefix_string)
...
app.register_blueprint(controllers.search, url_prefix = url_prefix_string)
